...
class blood_glucose: UIViewController {
    ...
    @IBOutlet weak var lbl_navigation_title:UILabel! {
        didSet {
            lbl_navigation_title.text = "BLOOD GLUCOSE"
        }
    }
    ...
    @objc func add_click_method() {
        ...
        let push = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "add_blood_glucose_id")
        ...
        if let person = UserDefaults.standard.value(forKey: str_save_login_user_data) as? [String:Any] {
            ...
            if let token_id_is = UserDefaults.standard.string(forKey: str_save_last_api_token) {
                ...
                if (self.str_instake_status == "0") {
                    ...
                    let cell = self.tble_view.cellForRow(at: indexPath) as! blood_glucose_table_cell
                    parameters = [
                        "action"        : "glucoselist",
                        "userId"        : String(myString),
...
//MARK:- TABLE VIEW -
extension blood_glucose: UITableViewDataSource , UITableViewDelegate, ChartViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if indexPath.row == 0 {
            let cell:blood_glucose_table_cell = tableView.dequeueReusableCell(withIdentifier: "one_table_cell") as! blood_glucose_table_cell
            ...
            let yVals2 = (0..<swiftArray.count).map { (i) -> BarChartDataEntry in
                ...
                if ("\(item["bloodGlucose"]!)" == "") {
                    ...
                    add_time += Double("\(item["bloodGlucose"]!)")!
                }
                
                let myDouble = Double("\(item["bloodGlucose"]!)")
                return BarChartDataEntry(x: Double(i), y: myDouble!)
            }
            
            let doubleStr = String(format: "%.2f", (add_time / Double(swiftArray.count)))
            cell.lbl_on_avg.text = String(doubleStr) + " on average"
            ...
            let cell:blood_glucose_table_cell = tableView.dequeueReusableCell(withIdentifier: "two_table_cell") as! blood_glucose_table_cell
            ...
            let cell:blood_glucose_table_cell = tableView.dequeueReusableCell(withIdentifier: "three_table_cell") as! blood_glucose_table_cell
            ...
            cell.lbl_value.text = "\(item!["bloodGlucose"]!) mmol/L"
