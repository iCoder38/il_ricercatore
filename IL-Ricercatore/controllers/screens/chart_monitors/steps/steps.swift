...
class steps: UIViewController {
    ...
    @objc func delete_steps_click_method(_ sender:UIButton) {
        ...
        print(sender.tag)
        let item = self.arrSteps[sender.tag] as? [String:Any]
        print(item as Any)
    ...
    @objc func showDateSelectionPopup() {
        ...
        // startDatePicker.minimumDate = Calendar.current.date(byAdding: .day, value: -30, to: Date()) // Minimum date is 30 days ago
        ...
        // endDatePicker.minimumDate = Calendar.current.date(byAdding: .day, value: -30, to: Date()) // Minimum date is 30 days ago
...
extension steps: UITableViewDataSource , UITableViewDelegate, ChartViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if (indexPath.row == 0) {
            ...
            let swiftArray = self.arrSteps.compactMap { $0 as? [String: Any] }
...
//            var set_bmp:String! = "0"
            ...
            let cell:steps_table_cell = tableView.dequeueReusableCell(withIdentifier: "three_steps_table_cell") as! steps_table_cell
            ...
            let item = self.arrSteps[indexPath.row-2] as? [String:Any]
            ...
            cell.lbl_value.text = "\(item!["totalSteps"]!) Total steps"
