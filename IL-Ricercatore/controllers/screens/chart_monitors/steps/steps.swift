...
//MARK:- TABLE VIEW -
extension steps: UITableViewDataSource , UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if (self.str_step_status == "0") {
            ...
            let cell:sleep_table_cell = tableView.dequeueReusableCell(withIdentifier: "one_steps_table_cell") as! sleep_table_cell
            ...
            let cell:sleep_table_cell = tableView.dequeueReusableCell(withIdentifier: "two_steps_table_cell") as! sleep_table_cell
