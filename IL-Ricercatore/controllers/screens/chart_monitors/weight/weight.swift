...
import DGCharts
import Charts
class weight: UIViewController, ChartViewDelegate {
    ...
    @IBOutlet weak var lbl_navigation_title:UILabel! {
        didSet {
            lbl_navigation_title.text = navigation_title_weight_en
        }
    }
    ...
    @objc func add_click_method() {
        ...
        let push = UIStoryboard.init(name: "Main", bundle: Bundle.main).instantiateViewController(withIdentifier: "add_weight_id")
        ...
        if let person = UserDefaults.standard.value(forKey: str_save_login_user_data) as? [String:Any] {
            ...
            if let token_id_is = UserDefaults.standard.string(forKey: str_save_last_api_token) {
                ...
                if (self.str_status == "0") {
                    ...
                    let cell = self.tble_view.cellForRow(at: indexPath) as! weight_table_cell
                    parameters = [
                        "action"        : "weightlist",
                        "userId"        : String(myString),
...
//MARK:- TABLE VIEW -
extension weight: UITableViewDataSource , UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if (indexPath.row == 0) {
            let cell:weight_table_cell = tableView.dequeueReusableCell(withIdentifier: "weight_one_table_cell") as! weight_table_cell
            ...
            let yVals2 = (0..<self.arr_heart.count).map { (i) -> BarChartDataEntry in
                ...
                add_time += Double("\(item!["weight"]!)")!
                let myDouble = Double("\(item!["weight"]!)")
...
//            var set_bmp:String! = "0"
            ...
            let cell:weight_table_cell = tableView.dequeueReusableCell(withIdentifier: "weight_two_table_cell") as! weight_table_cell
            ...
            let cell:weight_table_cell = tableView.dequeueReusableCell(withIdentifier: "weight_three_table_cell") as! weight_table_cell
            ...
            cell.lbl_value.text = "\(item!["weight"]!) KG"
