...
class walk_reminder: UIViewController, UNUserNotificationCenterDelegate {
    ...
    @IBOutlet weak var lbl_navigation_title:UILabel! {
        didSet {
            lbl_navigation_title.text = "WALK REMINDER"
    ...
    @objc func get_all_reminders_workout() {
        ...
        let cell = self.tble_view.cellForRow(at: indexPath) as! walk_reminders_table_cell
        ...
        UNUserNotificationCenter.current().getPendingNotificationRequests { (requests) in
            ...
            for request in requests {
                ...
                DispatchQueue.main.asyncAfter(deadline: .now() + 0.1) { [self] in
                    if ("\(request.identifier)") == identifier_walk_reminder_remind_me_every_at {
                    ...
                    // sunday
                    if ("\(request.identifier)") == identifier_walk_sunday {
                    ...
                    if ("\(request.identifier)") == identifier_walk_monday {
                    ...
                    if ("\(request.identifier)") == identifier_walk_tuesday {
                    ...
                    // wednesday
                    if ("\(request.identifier)") == identifier_walk_wednesday {
                    ...
                    // thursday
                    if ("\(request.identifier)") == identifier_walk_thursday {
                    ...
                    // friday
                    if ("\(request.identifier)") == identifier_walk_friday {
                    ...
                    // saturday
                    if ("\(request.identifier)") == identifier_walk_saturday {
    ...
    @objc func disable_all_days() {
        ...
        center.removePendingNotificationRequests(withIdentifiers: [identifier_walk_sunday,
                                                                   identifier_walk_monday,
                                                                   identifier_walk_tuesday,
                                                                   identifier_walk_wednesday,
                                                                   identifier_walk_thursday,
                                                                   identifier_walk_friday,
                                                                   identifier_walk_saturday])
    ...
    @objc func remind_me_every_at_click_method() {
        ...
        if (cell.btn_reminde_me_every_at_time.tag == 0) {
            ...
            // disable reminder
            self.disable_reminder(identifier: identifier_walk_reminder_remind_me_every_at, text: type_workout_remind_me_every_at)
        }
    ...
    @objc func sunday_click_method() {
        ...
        if (cell.btn_sunday_time.tag == 0) {
            ...
            // disable reminder
            self.disable_reminder(identifier: identifier_walk_sunday, text: type_sunday)
        }
    }
    ...
    @objc func time_picker_sunday() {
        ...
        RPicker.selectDate(title: "Select Time", cancelText: "Cancel", datePickerMode: .time, didSelectDate: { (selectedDate) in
            ...
            self.weekday_reminder(header: local_notification_walk_reminder_header,
                                  body: local_notification_walk_reminder_body,
                                  day: day_sunday,
                                  get_full_time: String(self.str_selected_time),
                                  identifier: identifier_walk_sunday,
                                  type: type_sunday)
    ...
    @objc func monday_click_method() {
        ...
        if (cell.btn_monday_time.tag == 0) {
            ...
            // disable reminder
            self.disable_reminder(identifier: identifier_walk_monday, text: type_monday)
        }
    }
    ...
    @objc func time_picker_monday() {
        ...
        RPicker.selectDate(title: "Select Time", cancelText: "Cancel", datePickerMode: .time, didSelectDate: { (selectedDate) in
            ...
            self.weekday_reminder(header: local_notification_walk_reminder_header,
                                  ...
                                  day: day_monday,
                                  get_full_time: String(self.str_selected_time),
                                  identifier: identifier_walk_monday,
                                  type: type_monday)
    ...
    @objc func tuesday_click_method() {
        ...
        if (cell.btn_tuesday_time.tag == 0) {
            ...
            // disable reminder
            self.disable_reminder(identifier: identifier_walk_tuesday, text: type_tuesday)
        }
    }
    ...
    @objc func time_picker_tuesday() {
        ...
        RPicker.selectDate(title: "Select Time", cancelText: "Cancel", datePickerMode: .time, didSelectDate: { (selectedDate) in
            ...
            self.weekday_reminder(header: local_notification_walk_reminder_header,
                                  ...
                                  day: day_tuesday,
                                  get_full_time: String(self.str_selected_time),
                                  identifier: identifier_walk_tuesday,
                                  type: type_tuesday)
    ...
    @objc func wednesday_click_method() {
        ...
        if (cell.btn_wednesday_time.tag == 0) {
            ...
            // disable reminder
            self.disable_reminder(identifier: identifier_walk_wednesday, text: type_wednesday)
        }
    }
    ...
    @objc func time_picker_wednesday() {
        ...
        RPicker.selectDate(title: "Select Time", cancelText: "Cancel", datePickerMode: .time, didSelectDate: { (selectedDate) in
            ...
            self.weekday_reminder(header: local_notification_walk_reminder_header,
                                  ...
                                  day: day_wednesday,
                                  get_full_time: String(self.str_selected_time),
                                  identifier: identifier_walk_wednesday,
                                  type: type_wednesday)
    ...
    @objc func thursday_click_method() {
        ...
        if (cell.btn_thursday_time.tag == 0) {
            ...
            // disable reminder
            self.disable_reminder(identifier: identifier_walk_thursday, text: type_thursday)
        }
    }
    ...
    @objc func time_picker_thursday() {
        ...
        RPicker.selectDate(title: "Select Time", cancelText: "Cancel", datePickerMode: .time, didSelectDate: { (selectedDate) in
            ...
            self.weekday_reminder(header: local_notification_walk_reminder_header,
                                  ...
                                  day: day_thursday,
                                  get_full_time: String(self.str_selected_time),
                                  identifier: identifier_walk_thursday,
                                  type: type_thursday)
    ...
    @objc func friday_click_method() {
        ...
        if (cell.btn_friday_time.tag == 0) {
            ...
            // disable reminder
            self.disable_reminder(identifier: identifier_walk_friday, text: type_friday)
        }
    }
    ...
    @objc func time_picker_friday() {
        ...
        RPicker.selectDate(title: "Select Time", cancelText: "Cancel", datePickerMode: .time, didSelectDate: { (selectedDate) in
            ...
            self.weekday_reminder(header: local_notification_walk_reminder_header,
                                  ...
                                  day: day_friday,
                                  get_full_time: String(self.str_selected_time),
                                  identifier: identifier_walk_friday,
                                  type: type_friday)
    ...
    @objc func saturday_click_method() {
        ...
        if (cell.btn_saturday_time.tag == 0) {
            ...
            // disable reminder
            self.disable_reminder(identifier: identifier_walk_saturday, text: type_saturday)
        }
    }
    ...
    @objc func time_picker_saturday() {
        ...
        RPicker.selectDate(title: "Select Time", cancelText: "Cancel", datePickerMode: .time, didSelectDate: { (selectedDate) in
            ...
            self.weekday_reminder(header: local_notification_walk_reminder_header,
                                  ...
                                  day: day_saturday,
                                  get_full_time: String(self.str_selected_time),
                                  identifier: identifier_walk_saturday,
                                  type: type_saturday)
...
//MARK:- TABLE VIEW -
extension walk_reminder: UITableViewDataSource , UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        let cell:walk_reminders_table_cell = tableView.dequeueReusableCell(withIdentifier: "walk_reminders_table_cell") as! walk_reminders_table_cell
